...
A linear model shows there were no significant effects of any factors (or of Trial order). We can conclude there was no effect on how *much* the babies looked at the stimuli.  
...
# summary(fcrnse_lm)
```
## (not run anymore) "Posthoc" for NSE babies only
